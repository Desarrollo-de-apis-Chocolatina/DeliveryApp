...
export class PlatillosService {
  ...
  private async findPlatilloOrFail(
    ...
    if (existe) {
        ...
        'Ya existe un platillo con ese nombre.',
        );
    }
    ...
    Object.assign(platillo, {
        ...
        descripcion:
        updatePlatilloDto.descripcion ?? platillo.descripcion,
        precio: updatePlatilloDto.precio ?? platillo.precio,
        disponible:
        updatePlatilloDto.disponible ?? platillo.disponible,
    });
    ...
    async marcarNoDisponiblePorIngrediente(
